            ...
            <div className="profile-options-wrapper">
                  ...
                  <div className="personal-wrapper">
                    <form className="personal-forms-wrapper">
                      ...
                      <div className="save-options">
                        <button type="button" className="save-personal" id="save-personal">
                          Save
                        </button>
                    ...
                    <div className="before-edit">
                      ...
                      <button type="button" id="edit-personal" className="edit-button">
                        Edit
                      </button>
                    </div>
                  </div>
              ...
              <div className="option-wrapper">
                ...
                <div className="option-data" id="option-8-data">
                  ...
                  <a href="contactus@mymoneymantra.com">
                    <button>contactus@mymoneymantra.com</button>
                  </a>
                </div>
              </div>
            </div>
