    ...
    if (field.type === 'checkbox') {
        ...
        inputs.forEach(inp => {
            if (inp.input_id === field.name) {
                ...
                if (testFiles.value && inp.number_of_uploads && testFiles.value.length > inp.number_of_uploads) {
                    field.value = null
                    field.error = true
                ...
                if (!noOfUploadsError && testFiles.value && testFiles.value.length && inp.max_upload_size_in_mb) {
