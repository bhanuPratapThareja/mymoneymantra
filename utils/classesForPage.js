const classes = {
  ...
  'credit-score-profile': [
    ...
    'app-progress',
    'app-status',
    'creditProfile-score-flow',
    'creditProfile-age-flow',
  ],
  'cp-rank': [
    'credit-card-flow',
    'credProfile',
  ...
  'cp-utilization': [
    ...
    'app-progress',
    'app-status',
    'creditProfile-utilization-flow',
    'creditProfile-age-flow',
  ],
  'cp-age': [
    'credit-card-flow',
