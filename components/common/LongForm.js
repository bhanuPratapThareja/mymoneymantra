...
class LongForm extends React.Component {
    ...
    componentDidMount() {
        ...
        const { long_form, always_ask_for_otp } = this.props.data.long_form_version_2
                    ...
                    {this.state.longFormSections.map(longFormSection => {
                        ...
                        return (
                            <React.Fragment key={longFormSection.id}>
                                <h3 onClick={this.openOtpModal}>{longFormSection.section_display_name}</h3>
                                ...
                                <div className="lets-find-content otp-card_custom">
                                    ...
                                    <div className="otp-wrapper login-options">
                                        ...
                                        <div className="cstm-opt-txt">
                                            ...
                                            <span className="resend_otp" onClick={() => getOtp(this.state.mobileNo)}>
                                                Resend
                                        </span>
                                        </div>
                                    </div>
                                </div>
                                <button type="button" onClick={this.onSubmitOtp}>Submit OTP</button>
                            </div>
                        </form>
                    </Modal> : null}
            </div>
