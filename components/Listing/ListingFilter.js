...
class ListingFilter extends React.Component {
    ...
    componentDidMount() {
        if (this.props.filters.checkboxes.length) {
            this.props.filters.checkboxes.forEach(checkboxes => {
                checkboxes.showCheckboxes = this.state.showCheckboxes
                checkboxes.totalCheckboxes = checkboxes.values.length
                checkboxes.veiwAll = true
            })
            this.setState({ checkboxes: this.props.filters.checkboxes })
        }
        if (this.props.filters.filter_radio_name.length) {
            this.setState({ filter_radio_name: this.props.filters.filter_radio_name })
        }
        this.setState({ filter_fee_annual: this.props.filters.filter_fee_annual })
    }
    ...
    render() {
        const { checkboxes, filter_fee_annual, filter_radio_name } = this.state
        return (
                                        ...
                                        <div className="content-one" key={checkboxes.id}>
                                            ...
                                            <div className="fields-wrapper">
                                                ...
                                                {checkboxes.veiwAll ? <div className="view-all">
                                                    <button onClick={() => this.onClivkViewAll(checkboxes.type)}>{checkboxes.button_text}
