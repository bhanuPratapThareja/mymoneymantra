                            ...
                            <form>
                                ...
                                <div className="long-forms-wrapper">
                                    ...
                                    <div className="shortforms-container long-gender" value={this.state.gender} onChange={e => this.handleChange(e.target.value,'gender')}> 
                                        ...
                                        <input className="lets-checkbox" type="radio" id="female" name="gender" required value="female" />
                                        <input className="lets-checkbox" type="radio" id="male" name="gender" required  value="male"/>
                                        <input className="lets-checkbox" type="radio" id="other" name="gender" required value="other"/>
