...
const LongFormBanner = ({ data }) => {
    const strapi = new Strapi()
    const { bank_name, form_heading, product_type, banner_image } = data
            ...
            <section className="long-form-wrapper">
                <div className="card-info">
                    ...
                    <div className="form-range">
                        <h5><b id="long-form-complete">47%</b> Complete</h5>
                    ...
                    <form>
                        ...
                        <div className="long-forms-wrapper">
                            ...
                            <div className="shortforms-container long-gender">
                                <input className="lets-checkbox" type="radio" id="female" name="gender" required />
                                <input className="lets-checkbox" type="radio" id="male" name="gender" required />
                                <input className="lets-checkbox" type="radio" id="other" name="gender" required />
                        ...
                        <div className="long-form-submit">
                            <button id="long-submit">Submit Application</button>
                        </div>
