const CreditUtilizationAllAccounts = () => {
  return (
      ...
      <div className="product-wrapper">
        <div className="container head">
          <div className="switch-tab tab">
            <button className="tablinks" onclick="appStatus(event, 'accepted')">
              <span></span>
              <h2>Active</h2>
            </button>
            <button className="tablinks active" onclick="appStatus(event, 'rejected')">
              <span></span>
              <h2>Closed</h2>
            </button>
        ...
        <div id="accepted" className="cards-wrapper container tabcontent" style={{ display: 'none' }}>
                      ...
                      <div id="cu_percent">
                        <svg viewBox="0 0 100 100" style={{ display: 'block', width: '100%' }}>
                          ...
                          <path
                            ...
                            stroke-width="10"
                            fill-opacity="0"
                            style={{ strokeDasharray: '282.783, 282.783', strokeDashoffset: '56.5566', strokeLinecap: 'round' }}
                          ></path>
                        </svg>
                        <div
