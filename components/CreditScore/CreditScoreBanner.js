const CreditScoreBanner = () => {
  return (
    <section data-aos="fade-up" className="container banner new-credit-wrap">
      <div className="creditScore-wrapper">
        <div className="creditScore-wrapper-left">
          <div>
            <h2>Your Credit Score</h2>
            <img className="underline-img" src="https://the1thing.github.io/MyMoneyMantra/build/images/CP_profile/underline.png" alt="" />
          </div>
          <div className="score-scale-img">
            <img src="https://the1thing.github.io/MyMoneyMantra/build/images/CP_profile/score-scale.png" alt="" />
          </div>
        </div>
