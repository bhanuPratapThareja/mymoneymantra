...
const AgeCreditAllAccounts = ({ active, closed }) => {
  ...
  return (
    <>
      <section className="product-offer allAccount-section">
        ...
        <div className="product-wrapper">
          ...
          {activeTab === 'accepted' ? (
            <div id="accepted" className="cards-wrapper container tabcontent detailed-cards" style={{ display: 'grid' }}>
              {active?.map((item, i) => (
                <div key={i} className="popular-cards-slider-card" onClick={() => modalOpenHandle(item)}>
      ...
      {open && (
        <section class="listing-modal mm-modal cards-popup-wrap" id="cards-popup-wrap" style={{ display: 'block' }} onClick={() => setOpen(false)}>
          <div class="overlay"></div>
          <div class="mm-modal-wrapper">
            <div class="heads">
              <svg class="filter-cross" width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" onClick={() => setOpen(false)}>
                <path
            ...
            <div class="cards-popup-content">
              <div class="card-details">
                ...
                <h5 class="card-num">{modalData?.accountNo}</h5>
                <div class="values-wrap">
                  ...
                  <div class="values">
                    ...
                    <h5 class="status">{modalData?.accountStatus}</h5>
                  </div>
                  <div class="values">
                  ...
                  <div class="values">
                    ...
                    <h5>{modalData?.lastPaymentDate && moment(modalData?.lastPaymentDate).format('DD MMM YYYY')}</h5>
                  </div>
                </div>
              </div>
              <div class="graph">
                ...
                <h5>₹4,20,000</h5>
                <canvas id="modalmyChart" height="440" width="880" style={{ display: 'block', width: '440px', height: '220px' }}></canvas>
              </div>
            </div>
          </div>
        </section>
...
export default AgeCreditAllAccounts
